...
(function ($) {
    ...
    $.fn.pagination.defaults = { total: 1, pageSize: 15, pageNumber: 1, pageList: [15, 30, 45, 60, 75], loading: false, buttons: null, showPageList: true, showRefresh: true, links: 10, layout: ["list", "sep", "first", "prev", "sep", "manual", "sep", "next", "last", "sep", "refresh"], onSelectPage: function (_c6, _c7) {
...
//           win.window("window").css({top:document.body.scrollHeight/2-parent.document.body.scrollHeight+document.body.scrollHeight});        
        //修改结束
...
(function ($) {
    ...
    }, length: { validator: function (_455, _456) {
        var len = $.trim(_455).length;
        return len >= _456[0] && len <= _456[1];
    }, message: "Please enter a value between {0} and {1}."
    }, remote: { validator: function (_457, _458) {
        var data = {};
        data[_458[1]] = _457;
...
(function ($) {
    ...
    function _5f6(_62d, data) {
        ...
        //2014-12-10 edit by zhangzhuo 修改增加iframe扩展
//        if(!$(_62d).attr('ref'))
//        {
//            if(data.rows.length>=15)
//               $(_62d).datagrid('resize', { height: (data.rows.length * 25) + 130 });
//            else
//               $(_62d).datagrid('resize', { height: (15 * 25) + 130 });
//            var obj = $(window.parent.document.body).find('iframe');
//            if (obj.length > 0)
//                SetWinHeight(obj[0]);
//        }
       //iframe扩展结束
    ...
    $.fn.datagrid.defaults = $.extend({}, $.fn.panel.defaults, { sharedStyleSheet: false, frozenColumns: undefined, columns: undefined, fitColumns: false, resizeHandle: "right", autoRowHeight: true, toolbar: null, striped: false, method: "post", nowrap: true, idField: null, url: null, data: null, loadMsg: "Processing, please wait ...", rownumbers: false, singleSelect: false, ctrlSelect: false, selectOnCheck: true, checkOnSelect: true, pagination: false, pagePosition: "bottom", pageNumber: 1, pageSize: 15, pageList: [15, 30, 45, 60, 75, 100], queryParams: {}, sortName: null, sortOrder: "asc", multiSort: false, remoteSort: true, showHeader: true, showFooter: false, scrollbarSize: 18, rowEvents: { mouseover: _5d1(true), mouseout: _5d1(false), click: _5d9, dblclick: _5e3, contextmenu: _5e7 }, rowStyler: function (_76a, _76b) {
